...
import com.example.geekyhub.instagramclone.databinding.FollowRvBinding



class FollowRvAdapter(var context:Context,var followList:ArrayList<com.example.geekyhub.instagramclone.Models.User>):RecyclerView.Adapter<FollowRvAdapter.ViewHolder>() {
